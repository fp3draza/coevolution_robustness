...
# find all files
file_names_truncated <- list.files("/home/fernando/network_rewiring/output/no_coevolution/truncated/summarised_output/no_coevolution/",
                        full.names = TRUE)

file_names_uniform <- list.files("/home/fernando/network_rewiring/output/no_coevolution/uniform/summarised_output/no_coevolution/",
                                   full.names = TRUE)
...
# store 
save(metrics_no_coevolution, file = '/home/fernando/network_rewiring/results/metrics_no_coevolution.Rda')
