...
# load data (these paths should be fixed accordingly)
load("/home/fernando/coevolution_robustness/results/metrics_with_coevolution.Rda")
load("/home/fernando/coevolution_robustness/results/metrics_without_coevolution.Rda")
...
a / correlation_raw
ggsave("figure_S3.pdf", path="/home/fernando/coevolution_robustness/figures/",
...
ggsave("figure_S7.pdf", path="/home/fernando/coevolution_robustness/figures/",
       width=180, height=220, units="mm", dpi=600, device = cairo_pdf)
...
b
ggsave("figure_2.pdf", path="/home/fernando/coevolution_robustness/figures/",
...
ggsave("figure_S4.pdf", path="/home/fernando/coevolution_robustness/figures/", width=180, height=240, units="mm", dpi=600, device = cairo_pdf)
...
ggsave("figure_5.pdf", path="/home/fernando/coevolution_robustness/figures/", width=180, height=220, units="mm", dpi=600, device = cairo_pdf)
...
ggsave("figure_S5.pdf", path="/home/fernando/coevolution_robustness/figures/",
       width=180, height=220, units="mm", dpi=600, device = cairo_pdf)
...
ggsave("figure_S6.pdf", path="/home/fernando/coevolution_robustness/figures/",
...
s1a + s1b
ggsave("figure_S1.pdf", path="/home/fernando/coevolution_robustness/figures/",
       width=180, height=100, units="mm", dpi=600, device = cairo_pdf)
...
s3a / s3b
ggsave("figure_S10.pdf", path="/home/fernando/coevolution_robustness/figures/",
...
ggsave("figure_S12.pdf", path="/home/fernando/coevolution_robustness/figures/",
       width=180, height=220, units="mm", dpi=600, device = cairo_pdf)
...
ggsave("figure_4.pdf", path="/home/fernando/coevolution_robustness/figures/",
       width=180, height=140, units="mm", dpi=600, device = cairo_pdf)

figure_2.5_b + figure_2.5_a
ggsave("figure_3.pdf", path="/home/fernando/coevolution_robustness/figures/",
       width=180, height=140, units="mm", dpi=600, device = cairo_pdf)
...
figure_2.5_a / correlation_diff +
  plot_layout(guides = "collect") & theme(legend.position = 'bottom')
ggsave("new_figure_2.5_v2.pdf", path="/home/fernando/coevolution_robustness/figures/",
       width=180, height=220, units="mm", dpi=600, device = cairo_pdf)
...
metrics %>%
  ...
  theme(legend.position = 'bottom', aspect.ratio = 1,
        ...
        axis.text = element_text(size = 10)) +
  scale_colour_gradientn(colors=c(pal_correlation))
ggsave("figure_S11.pdf", path="/home/fernando/coevolution_robustness/figures/",
       width=180, height=220, units="mm", dpi=600, device = cairo_pdf)
...
correlation_components_diff +  plot_annotation("relative change in number of components") & theme(plot.title = element_text(hjust = 0.5, face = 'bold'))
ggsave("figure_S9.pdf", path="/home/fernando/coevolution_robustness/figures/",
       width=180, height=140, units="mm", dpi=600, device = cairo_pdf)
...
ggsave("figure_S8.pdf", path="/home/fernando/coevolution_robustness/figures/", width=180, height=240,
...
# load results
load("/home/fernando/coevolution_robustness/results/empirical_size/metrics.Rda")
...
ggsave("figure_S2.pdf", path="/home/fernando/coevolution_robustness/figures/",
       width=180, height=140, units="mm", dpi=600, device = cairo_pdf)
